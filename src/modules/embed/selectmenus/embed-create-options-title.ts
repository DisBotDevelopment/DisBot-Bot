            ...
            switch (value) {
                case "title": {
                    ...
                    modal
                        ...
                        .setCustomId("modal-embed-create-title:" + interaction.customId.split(":")[1] + ":" + (interaction.customId.split(":")[2] ?? "0"))
                ...
                case "url": {
                    ...
                    modal
                        .setTitle("Embed Editor")
                        .setCustomId("modal-embed-create-url:" + interaction.customId.split(":")[1] + ":" + (interaction.customId.split(":")[2] ?? "0"));
