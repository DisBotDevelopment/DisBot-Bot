            ...
            switch (value) {
                case "text": {
                    ...
                    modal
                        ...
                        .setCustomId("modal-embed-create-footer:" + interaction.customId.split(":")[1] + ":" + (interaction.customId.split(":")[2] ?? "0"));
                ...
                case "img": {
                    ...
                    modal
                        .setTitle("Embed Editor")
                        .setCustomId("modal-embed-create-footer-img:" + interaction.customId.split(":")[1] + ":" + (interaction.customId.split(":")[2] ?? "0"));
