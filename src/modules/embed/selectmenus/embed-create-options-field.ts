            ...
            switch (value) {
                case "add": {
                    ...
                    modal
                        ...
                        .setCustomId("modal-embed-create-filds-add:" + interaction.customId.split(":")[1] + ":" + (interaction.customId.split(":")[2] ?? "0"));
                ...
                case "remove": {
                    ...
                    modal
                        .setTitle("Embed Editor")
                        .setCustomId("modal-embed-create-filds-remove:" + interaction.customId.split(":")[1] + ":" + (interaction.customId.split(":")[2] ?? "0"));
