...
export default {
    ...
    async execute(interaction: ButtonInteraction, client: ExtendedClient) {
        ...
        modal.setCustomId(`vanity-update-title-modal:${data?.UUID}`)

        value.setCustomId("vanity-update-title-input")
            .setLabel("New Title")
            .setStyle(1)
            .setRequired(true)
            .setMaxLength(256)
            .setMinLength(1)
            .setPlaceholder("Enter the new title for your vanity URL");
