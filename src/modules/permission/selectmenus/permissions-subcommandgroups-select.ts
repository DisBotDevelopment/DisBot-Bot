...
export default {
    id: "permissions-subcommandgroups-select",
                            ...
                            new TextDisplayBuilder()
                                .setContent(
                                    [`## ${await convertToEmojiToPng("terminal")} ${data.CommandName.split(".").join(" ")} (${data.UUID})`,
                                        ``,
                                        `**Interaction Name:** ${client.subCommandGroups.get(data.CommandName).interactionName ?? "N/A"}`,
                                        `**Description:** ${client.subCommandGroups.get(data.CommandName).interactionDescription ?? "N/A"}`,
