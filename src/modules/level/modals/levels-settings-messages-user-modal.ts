...
export default {
    id: "levels-settings-messages-user-modal",
    ...
    async execute(interaction: ModalSubmitInteraction, client: ExtendedClient) {
        try {
            ...
            await database.levelSettings.update({
                ...
                data: {
                    LevelUserInfoMessageTemplate: input
                }
            })

            await sendDefaultMessage(`## ${await convertToEmojiToPng("check")} Updated the User Level Rank Message Template.`, interaction, true, "reply")
