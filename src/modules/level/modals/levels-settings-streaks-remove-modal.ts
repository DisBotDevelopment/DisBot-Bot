...
export default {
    id: "levels-settings-streaks-remove-modal",
    ...
    async execute(interaction: ModalSubmitInteraction, client: ExtendedClient) {
        try {
            ...
            await database.xPStreaks.deleteMany({
                where: {
            ...
            await sendDefaultMessage(`## ${await convertToEmojiToPng("check")} Deleted Streak Day ${input} successfully.`, interaction, true, "reply")
