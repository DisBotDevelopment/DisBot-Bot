...
export default {
    id: "levels-settings-leaderboard-message-modal",
    ...
    async execute(interaction: ModalSubmitInteraction, client: ExtendedClient) {
        try {
            ...
            await database.levelSettings.update({
                ...
                data: {
                    LeaderboardMessageTemplateId: input
                }
            })

            await sendDefaultMessage(`## ${await convertToEmojiToPng("check")} Updated the Leaderboard Message Template.`, interaction, true, "reply")
