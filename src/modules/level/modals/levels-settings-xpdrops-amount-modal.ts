...
export default {
    id: "levels-settings-xpdrops-amount-modal",
    ...
    async execute(interaction: ModalSubmitInteraction, client: ExtendedClient) {
        try {
            ...
            await database.xPDrops.update({
                ...
                data: {
                    ClaimAmount: parseInt(input)
                }
            })

            await sendDefaultMessage(`## ${await convertToEmojiToPng("check")} Changed Claim Amount to ${input}.`, interaction, true, "reply")
