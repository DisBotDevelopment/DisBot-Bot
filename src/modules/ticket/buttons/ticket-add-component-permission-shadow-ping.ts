    ...
    async execute(interaction: ButtonInteraction, client: ExtendedClient) {
        ...
        if (data.HasShadowPing) {
            ...
            await interaction.reply({
                ...
                content: `## ${await convertToEmojiToPng("check")} Disabled shadow-ping for <@&${data.DiscordRoleId}> successfully.`
            })
            ...
            await interaction.reply({
                flags: MessageFlags.Ephemeral,
                content: `## ${await convertToEmojiToPng("check")} Enabled shadow-ping for <@&${data.DiscordRoleId}> successfully.`
            })
