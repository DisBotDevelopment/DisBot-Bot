    ...
    async execute(interaction: ModalSubmitInteraction, client: ExtendedClient) {
        ...
        try {
            ...
            return await interaction.reply({
                ...
                content: `## ${await convertToEmojiToPng("error")} You need to set a number 1 of Short and 2 for Paragraph`
            })
        }
        ...
        try {
            ...
            return await interaction.reply({
                flags: MessageFlags.Ephemeral,
                content: `## ${await convertToEmojiToPng("error")} Please select a valid Min-/Max-Length and Required Option!`,
            })
        }

        await interaction.reply({
            flags: MessageFlags.Ephemeral,
            content: `## ${await convertToEmojiToPng("check")} Added Modal Option successfully!`
        })
