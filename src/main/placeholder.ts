...
export const IMAGE_PLACEHOLDER = {
    ...
    "{user.avatar}": "https://cdn.jespersen.zip/u/TbZSAH.png",
    "{spotify.episode.image}": "https://cdn.jespersen.zip/u/nM7pNI.png",
    "{spotify.author.image}": "https://cdn.jespersen.zip/u/HsqWSk.png",
    "{polls.image}": "https://i.imgur.com/FHBicGA.png",
    "{welcome.image}": "https://cdn.jespersen.zip/u/e3IChB.png",
    "{level.rankCard}": "https://cdn.jespersen.zip/u/uFmQ8z.png",
    "{level.leaderboard.leaderboardImageHorizontal}": "https://cdn.jespersen.zip/u/dtKeTY.png",
    "{level.leaderboard.leaderboardImageDefault}": "https://cdn.jespersen.zip/u/aLvYLD.png",
    "{inviter.avatar}": "https://cdn.jespersen.zip/u/7cU4sY.png",
};
...
export function replacePlaceholders(template: string, data: Record<string, any>): string {
    ...
    let fullPlaceholder = template.replace(/cdn\.xyzhub\.link/i, "cdn.jespersen.zip");
