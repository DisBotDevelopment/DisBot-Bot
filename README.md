...
[![Static Badge](https://img.shields.io/badge/typedoc-%20?style=flat&logo=typescript&label=Code%20Docs&link=https%3A%2F%2Fdisbotdevelopment.github.io%2FDisBot-Bot%2F)](https://disbotdevelopment.github.io/DisBot-Bot/)
...
Welcome to **DisBot**  
This is the official open-source repository of DisBot! -- DisBot is a modern, modular Discord bot designed for
performance, expandability, and ease of use.
Developed for developers, server administrators, and communities that value flexibility, stability, and clear
structures.
...
More information is available in the [Documentation](https://doc.xyzhub.link/s/disbot/doc/usage-2BcJNRkxpX), including
