...
{
    /// <inheritdoc />
    public partial class RenamedToSharedGuilds : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserSharedGuilds", x => x.Id);
                    table.ForeignKey(
                        name: "FK_UserSharedGuilds_Guilds_GuildId",
                        column: x => x.GuildId,
                        principalTable: "Guilds",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_UserSharedGuilds_Users_UserId",
                        column: x => x.UserId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserSharedGuilds_GuildId",
                table: "UserSharedGuilds",
                column: "GuildId");

            migrationBuilder.CreateIndex(
                name: "IX_UserSharedGuilds_UserId",
                table: "UserSharedGuilds",
                column: "UserId");
        }
